...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_ACCELERATION (220.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (220.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (150.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_X_MAX_TRAVEL 312.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 452.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 102.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_SPINDLE_RPM_MAX 255.0 // rpm
  #define DEFAULT_SPINDLE_RPM_MIN 1 // rpm
